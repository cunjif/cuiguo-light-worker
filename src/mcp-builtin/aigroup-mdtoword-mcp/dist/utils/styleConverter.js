...
export class StyleConverter {
     ...
     * 将旧版样式配置转换为新版样式配置
     */
    static convertLegacyToNew(legacyConfig) {
        const newConfig = {};
        // 转换段落样式
     ...
     * 将新版样式配置转换为旧版样式配置
     */
    static convertNewToLegacy(newConfig) {
        const legacyConfig = {
            paragraphStyles: {},
            characterStyles: {},
            tableStyles: {},
...
//# sourceMappingURL=styleConverter.js.map