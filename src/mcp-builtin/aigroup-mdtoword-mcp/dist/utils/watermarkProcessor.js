...
export class WatermarkProcessor {
     ...
     * 创建水印配置
     */
    static createWatermark(config) {
        const { text, font = '宋体', size = 100, color = 'CCCCCC', opacity = 0.3, rotation = -45, position = 'diagonal' } = config;
        // docx库的水印配置
        return {
            text: text,
            font: font,
     ...
     * 验证水印配置
     */
    static validateWatermarkConfig(config) {
        const errors = [];
...
//# sourceMappingURL=watermarkProcessor.js.map