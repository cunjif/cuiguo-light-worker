...
export function registerConvertTool(server) {
    server.tool('convert_to_markdown', 'Convert a local file to Markdown text. Supports PDF, DOCX, XLSX, PPTX, HTML, CSV, EPUB, images, audio and more.', {
...
//# sourceMappingURL=tool-register.js.map