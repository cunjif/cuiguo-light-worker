...
export function createConverterInputFromBuffer(data, maxBufferSize) {
...
export function createConverterInputFromStream(source, maxBufferSize) {
    let cached;
...
//# sourceMappingURL=converter-input.js.map